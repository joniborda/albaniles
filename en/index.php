				...
				<div class="container">
					...
					<div class="collapse navbar-collapse appiNav">
						<ul class="nav navbar-nav">
							<li><a href="#featureWrap">Característica</a></li>
...
<!--							<li><a href="#testimonialsWrap">Testimonio</a></li>-->
			...
			<div id="topWrap" class="jumbotron" itemscope itemtype="http://schema.org/NewsArticle">
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
					<h1 itemprop="headline">Somos los constructores de la web</h1>
					<h2	itemprop="description">Diseñamos tu página como lo desees.</h2>
